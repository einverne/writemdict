...
class TestClass(unittest.TestCase):
    ...
    def test_basic_writing(self):
        """ Example 1: Basic writing. All options are default.
        """
    ...
    def test_utf16nonbmp_writing(self):
    ...
    def test_key_index_encryption(self):
    ...
    def test_version12_writing(self):
    ...
    def test_version12utf16_writing(self):
    ...
    def test_encryption_internal_regcode_device_id(self):
